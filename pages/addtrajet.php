...
<body>
  ...
  <div id="conteneur">
    ...
    <form action="Trimestre.php" id="ajouttrajet" method="POST">
      ...
      <h4><?php echo $libelleTrimestre['libelle']." ".$annee; ?> </h4>
      ...
      <input type="number" min="0" name="trajetcourt" id="trajetcourt"/></br>
      <label for="trajetmoyen">Nombre de trajet moyen : </label></br>
      <input type="number" min="0" name="trajetmoyen" id="trajetmoyen"/></br>
      <label for="trajetlong">Nombre de trajet long : </label></br>
      <input type="number" min="0" name="trajetlong" id="trajetlong"/></br>
