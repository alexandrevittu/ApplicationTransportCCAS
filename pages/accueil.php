...
/***** Pour recepurer le nombre de renouvellement d'adhesion passée dans la variable $_SESSIOn, ainsi on recuperer de page en page.******/
        ...
        $nb = getNbLigne();
         if ($nb['0']['nbLigne'] == 1 || $nb['0']['nbLigne'] == 0) {
            ...
            echo '<a class="renouvellementAccueil" href="PubliPostageCSV.php">Il y a '.$nb['0']['nbLigne'].' renouvellements d\'adhésions dans ce trimestre.</a>';
          }
    ...
    <fieldset>
      <legend><span class="glyphicon glyphicon-eye-open" ></span> &nbsp; Statistiques :</legend>
        ...
        <form action="FactuJanvAuj.php">
          <button class="btn btn-info" type="submit"><span class="glyphicon glyphicon-stats"></span> &nbsp; Facturation de janvier à aujourd'hui</button>
        </form>
    </fieldset>
  </div>
  <?php
